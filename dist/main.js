(() => {
    "use strict";
    var e, t, n, r, o, a, i, c, s, u, d, f, l, p, v = {
        192: (e, t, n) => {
            n.d(t, {Z: () => a});
            var r = n(645), o = n.n(r)()((function (e) {
                return e[1]
            }));
            o.push([e.id, "body{color:red}", ""]);
            const a = o
        }, 645: e => {
            ...
            function r(e, r) {
                for (var a = {}, i = [], c = 0; c < e.length; c++) {
                    var s = e[c], u = r.base ? s[0] + r.base : s[0], d = a[u] || 0, f = "".concat(u, " ").concat(d);
                    a[u] = d + 1;
                    var l = n(f), p = {css: s[1], media: s[2], sourceMap: s[3]};
                    -1 !== l ? (t[l].references++, t[l].updater(p)) : t.push({
                        identifier: f,
                        updater: o(p, r),
                        references: 1
                    }), i.push(f)
    ...
    }, h.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = h(379), t = h.n(e), n = h(795), r = h.n(n), o = h(569), a = h.n(o), i = h(565), c = h.n(i), s = h(216), u = h.n(s), d = h(589), f = h.n(d), l = h(192), (p = {}).styleTagTransform = f(), p.setAttributes = c(), p.insert = a().bind(null, "head"), p.domAPI = r(), p.insertStyleElement = u(), t()(l.Z, p), l.Z && l.Z.locals && l.Z.locals, document.body.appendChild(function () {
